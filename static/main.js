...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aC, request.aR, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {O: fragment, Q: host, W: path, Y: port_, aa: protocol, ab: query};
	});
...
var $author$project$Model$initModel = {R: '', T: _List_Nil, ah: _List_Nil};
...
var $author$project$Msg$GotRealtimeEvent = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Subscriptions$keyDecoder = A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string);
...
var $author$project$Ports$realtimeEvent = _Platform_incomingPort('realtimeEvent', $elm$json$Json$Decode$string);
var $author$project$Subscriptions$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Ports$realtimeEvent($author$project$Msg$GotRealtimeEvent),
				$elm$browser$Browser$Events$onKeyDown(
				A2($elm$json$Json$Decode$map, $author$project$Msg$KeyPressed, $author$project$Subscriptions$keyDecoder))
			]));
};
...
var $author$project$Msg$GotPostResponse = function (a) {
	return {$: 3, a: a};
};
var $author$project$Url$baseUrl = 'https://pocketbase-production-98a3.up.railway.app/';
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aq: false, as: r.as, aw: r.aw, ay: r.ay, aC: r.aC, aN: r.aN, aP: r.aP, aR: r.aR}));
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Update$createPost = function (content) {
	...
	return $elm$http$Http$request(
		{
			as: body,
			aw: $elm$http$Http$expectWhatever($author$project$Msg$GotPostResponse),
			ay: _List_Nil,
			aC: 'POST',
			aN: $elm$core$Maybe$Nothing,
			aP: $elm$core$Maybe$Nothing,
			aR: $author$project$Url$baseUrl + 'api/collections/posts/records'
		});
};
					...
					switch (_char) {
						case 'Backspace':
							return _Utils_update(
								model,
								{
									R: A2($elm$core$String$dropRight, 1, model.R)
								});
						case 'CapsLock':
							return model;
						case 'Shift':
						...
						default:
							return _Utils_update(
								model,
								{
									R: $elm$core$String$toUpper(
										_Utils_ap(model.R, _char))
								});
					}
				}();
				var newCmd = (_char === 'Enter') ? $author$project$Update$createPost(model.R) : $elm$core$Platform$Cmd$none;
...
var $author$project$View$prependQuestionmark = function (model) {
	return A2(
		$elm$core$List$map,
		function (s) {
			return A2($elm$core$List$member, s, model.ah) ? ('>>> ' + s) : ('<?> ' + s);
		},
		model.T);
};
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$author$project$View$prependQuestionmark(model))),
				A2(
				$elm$html$Html$span,
				_List_fromArray(
					[
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{aB: $author$project$Model$init, aM: $author$project$Subscriptions$subscriptions, aQ: $author$project$Update$update, aS: $author$project$View$view});
